const { createPost,getPosts,getPostById,updatePost,deletePost,getPostsByCreator } = require("../controllers/post");
...
route.get("/getPostsByCreator/:creator", getPostsByCreator);
